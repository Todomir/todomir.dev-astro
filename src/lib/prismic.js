...
export function serializer(type, element, content, children, classes) {
  switch (type) {
		case Elements.heading1:
			return `<h1 ${classes.h1 && `class=${classes.h1}`}>${children.join('')}</h1>`
		case Elements.heading2:
			return `<h2 ${classes.h2 && `class=${classes.h2}`}>${children.join('')}</h2>`
		case Elements.heading3:
			return `<h3 ${classes.h3 && `class=${classes.h3}`}>${children.join('')}</h3>`
		case Elements.heading4:
			return `<h4 ${classes.h4 && `class=${classes.h4}`}>${children.join('')}</h4>`
		case Elements.heading5:
			return `<h5 ${classes.h5 && `class=${classes.h5}`}>${children.join('')}</h5>`
		case Elements.heading6:
			return `<h6 ${classes.h6 && `class=${classes.h6}`}>${children.join('')}</h6>`
		case Elements.paragraph:
			return `<p ${classes.p && `class=${classes.p}`}>${children.join('')}</p>`
		case Elements.preformatted:
			return `<pre ${classes.pre && `class=${classes.pre}`}>${children.join('')}</pre>`
		case Elements.strong:
			return `<strong ${classes.strong && `class=${classes.strong}`}>${children.join('')}</strong>`
		case Elements.em:
			return `<em ${classes.em && `class=${classes.em}`}>${children.join('')}</em>`
		case Elements.listItem:
			return `<li ${classes.li && `class=${classes.li}`}>${children.join('')}</li>`
		case Elements.oListItem:
			return `<li ${classes.li && `class=${classes.li}`}>${children.join('')}</li>`
		case Elements.list:
			return `<li ${classes.li && `class=${classes.li}`}>${children.join('')}</li>`
		case Elements.oList:
			return `<ol ${classes.ol && `class=${classes.ol}`}>${children.join('')}</ol>`
		case Elements.image:
      ...
      `
		case Elements.hyperlink:
			...
			return `<a ${target} href="${linkUrl}" ${classes.a && `class=${classes.a}`}>${children.join('')}</a>`
		case Elements.label:
			var label = element.data.label ? ` class="${element.data.label} ${classes.label && classes.label}"` : ''
